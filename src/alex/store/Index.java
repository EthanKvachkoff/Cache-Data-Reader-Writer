...
public final class Index {
	...
	public void setData(byte[] data) {
        ...
        this.data = data;
        // Update other fields, such as CRC or Whirlpool, based on new data
        this.crc = CRC32HGenerator.getCrc(data);
        this.whirlpool = Whirlpool.getHash(data, 0, data.length);
    }
